...
import_logger_root!("build.rs", concat!(project_directory!(), "/log_out/boot_knockoff_gen.log"));
...
fn main() {
    ...
    info!("Initializing boot knockoff gen build.");
    // let generated: TokenStream = module_precompile::get_tokens(&"boot_knockoff_gen", &user_program_src!());
    // let out_file = codegen_utils::parse::open_out_file("codegen.rs");
    // codegen_utils::parse::write(out_file, generated.to_string().as_str(), "boot_knockoff_gen");
}
